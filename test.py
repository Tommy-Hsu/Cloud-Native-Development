...
class MyResourceTestCase(unittest.TestCase):
    ...
    def test_signup_post_request(self):
        response = requests.post('http://localhost:7777/signup', headers={"Content-Type": "application/json"}, data=json.dumps(self.payload))
    ...
    def tearDown(self) -> None:
        # myclient = MongoClient("mongodb+srv://michaellee:myatlas2023@cluster0.vmsth6v.mongodb.net/?retryWrites=true&w=majority")
